...
class encuentro(models.Model):
    ...
    competicion_id = models.ForeignKey(
        "appCompeticion.competicion",
        on_delete=models.CASCADE,
        db_column="competicion_id",
    )
    sede_id = models.ForeignKey(
        sede, on_delete=models.CASCADE, db_column="sede_id", blank=True, null=True
    )
    ...
    equipo_visita = models.ForeignKey(
        "appEquipo.equipo",
        on_delete=models.CASCADE,
        db_column="equipo_visita",
        related_name="equipo_visita",
    )
